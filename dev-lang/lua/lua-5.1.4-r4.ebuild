...
# $Header: /var/cvsroot/gentoo-x86/dev-lang/lua/lua-5.1.4-r4.ebuild,v 1.4 2009/12/07 18:20:26 tcunha Exp $
...
IUSE="+deprecated emacs readline"
...
src_compile() {
	...
	cd src
	emake CC="${CC}" MYCFLAGS="-DLUA_USE_LINUX ${CFLAGS}" \
			RPATH="${ROOT}/usr/$(get_libdir)/" \
			MYLIBS="${mylibs} ${liblibs}" \
			V=${PV} \
