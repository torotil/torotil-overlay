...
# $Header: /var/cvsroot/gentoo-x86/media-plugins/live/live-2009.06.02.ebuild,v 1.7 2009/08/09 12:50:44 nixnut Exp $
...
src_install() {
	for library in UsageEnvironment liveMedia BasicUsageEnvironment groupsock; do
		use nostatic || dolib.a live-static/${library}/lib${library}.a
	...
	use progs && find live-static/testProgs -type f -perm +111 -print0 | \
		xargs -0 dobin

	#install included live555MediaServer aplication
	use progs && dobin live-static/mediaServer/live555MediaServer
